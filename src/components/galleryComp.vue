...
.navtab_container {
  ...
  align-items: center;
  background-color: rgb(7, 1, 36);
}
.navtab_container img {
  height: 120px;
  width: auto;
}
.tabmenu_container {
...
.bigS::before {
  ...
  width: 100%;
  height: 100px;
  background: linear-gradient(to top #0b0c53, transparent);
  z-index: 1000;
}
.tabmenu_container li a:hover {
